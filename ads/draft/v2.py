...
class ST7789V3:
    def __init__(self):
        ...
        self._dc   = self._chip.get_line(DC_LINE)
        self._rst  = self._chip.get_line(RST_LINE)
        self._dc.request(consumer="st7789_dc",  type=gpiod.LINE_REQ_DIR_OUT)
        self._rst.request(consumer="st7789_rst", type=gpiod.LINE_REQ_DIR_OUT)
    ...
    def _reset(self):
        self._rst.set_value(0); time.sleep(0.1)
        self._rst.set_value(1); time.sleep(0.2)
...
def demo_animation(device, frames=80):
    print("  Animation...")
